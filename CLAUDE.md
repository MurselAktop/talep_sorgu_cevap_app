...
8. Genişletme Faz 2 — Hesap yönetimi (Profil sekmesi, şifre değiştirme, şifremi unuttum akışı)
...
- **Etkilenen yerler:** YENİ `profile_screen.dart`, YENİ `change_password_screen.dart`, `login_screen.dart` ("Şifremi unuttum" bağlantısı + sıfırlama ekranı), `home_screen.dart` (sekme/menü). Tablo değişikliği beklenmiyor.
